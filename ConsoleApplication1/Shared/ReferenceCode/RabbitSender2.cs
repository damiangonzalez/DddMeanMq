...
namespace Shared
{
    public class RabbitSender2<TRequest, TResponse> : RabbitConnector, IDisposable
    {
        private readonly string _responseQueue;
        private readonly QueueingBasicConsumer _consumer;
        private readonly string _exchangeName;

        public RabbitSender2()
        { }
        ...
        public RabbitSender2(RabbitConnectionSettings settings, string exchangeName)
        {
